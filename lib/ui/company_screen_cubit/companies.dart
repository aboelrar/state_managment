...
import 'package:getxapp/view_model_cubit/companies_state.dart';
...
class _CompaniesState extends State<Companies> {
  ...
  void initState() {
    ...
    bloc = BlocProvider.of<CompaniesViewModel>(context);
    bloc!.fetchData();
  }
  ...
  Widget _getBody() {
    ...
    return Scaffold(
      body: BlocBuilder<CompaniesViewModel, CompaniesStateCubit>(
